  ...
  ios: [
    {
      ...
      connectionRetryLimit: 1,       // försök igen vid fel
      connectionTimeout: 5000,       // timeout per enhet (ms)
      shutdownGracePeriod: 1000,      // tid att stänga ner säkert
      flushAt: 10,                   // skicka batch vid 50 pushar
